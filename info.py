...
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/567ffad10be4571f7199e.mp4")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinema_Kottaka_Re_Entry')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+6mRW3jIRAnFmZmU1')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Ramanan')
